...
@endif
     ...
     <h3 style=" display: flex; align-items: center; justify-content: center; "> CATEGORY MANAGEMENT  </h3>
     ...
     <div class="main-cards">
      <div class="carda">
        <div class="row">
            ...
            @can('role-create')
            <div class="btn btn-success"  data-toggle="modal" data-target="#modalCat"> Create New Category</div>
            @endcan
            </div>
            </div>
            </div>
            ...
            <table>
              ...
              <tbody>
                ...
                <td data-label="Action">
                  ...
                  <!--<a class="btn btn-info" href="{{ route('roles.show',$category->id) }}">Show</a>-->
            @can('role-edit')
            <a class="btn btn-primary" href="{{ route('editCat',$category->id) }}">Edit</a>
            @endcan
            @can('role-delete')
            {!! Form::open(['method' => 'DELETE','route' => ['destroyCat', $category->id],'style'=>'display:inline']) !!}
...
<div id="modale" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <!-- Modal HTML Markup -->
    <div id="modalCat" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" style="color:black;">Ajouter une categorie</h4>
          <button type="button" class="close" data-dismiss="modal">
            <span>&times;</span>
          </button> 
        </div>
        ...
        <div class="col-xl-12 order-xl-1">
          @if ($errors->any())
              ...
              <div class="alert alert-success">
               ...
               @endif
              <form action="{{route('storeCat')}}" method="POST"  enctype="multipart/form-data" class="form-horizontal">
                <h6 class="" style="text-align: center;font-family:Impact, Charcoal, sans-serif;"></h6>
                @csrf
                @if ($message = Session::get('success'))
                  <div class="alert alert-success">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <input type="text" id="title"  name="name" class="form-control form-control-alternative" placeholder="Catégorie" value="">
                      </div>
                    </div>
                    <div class="col-lg-6">
