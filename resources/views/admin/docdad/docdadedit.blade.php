...
<div class="grid-container">
   ...
   <aside class="sidenav">
     ...
     <ul class="sidenav__list ">
      <li  class="sidenav__list-item active "> <a href="{{ route('listDocs') }}"  style="color:white; font-weight:bold"><div>DASHBOARD</div></a></li>
    ...
    <li class='sidenav__list-item sub-menu'>
     <!-- <a href='#'><div class="row"><div class="" style="margin-right:10px;"> AJOUTER UN DOCUMENT</div><div class='fa fa-caret-down right'></div></div></a>-->
			<a href="{{ route('listDocs') }}" class="dropdown-toggle"  data-toggle="dropdown" style="color:white; font-weight:bold"> AJOUTER UN DOCUMENT </a>
      <ul>
   ...
   <main class="main">
     <div class="main-header">
      <div class="main-header__heading" style="font-weight:bold; font-size:20px; text-transform:uppercase; margin-top:-15px;" > <div class="">
        <form action="{{ route('listDocs') }}" method="GET" role="search">
       ...
       <div class="main-header__heading" style="font-weight:bold; font-size:15px; text-transform:uppercase;">Bonjour, Admin {{ auth()->user()->lastname }}</div>
...
@endif
     ...
     <h3 style=" display: flex; align-items: center; justify-content: center; "> INDEX DES DOCUMENTS </h3>
     ...
     <div class="main-cards">
      <div class="carda">
        <div class="row">
          ...
          <form action="{{ route('updateDoc',$doc->id) }}" method="POST"  enctype="multipart/form-data" class="form-horizontal">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group focused">
                    ...
                    <input type="text" id="title"  name="title" class="form-control form-control-alternative" placeholder="Rapport 2020 Projet Education" value="{{ old('title', $doc->title )}}">
                  </div>
                </div>
                <div class="col-lg-6">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group focused">
                    ...
                    <input type="text" id="auteur"  name="auteur" class="form-control form-control-alternative"  placeholder="ex. DP Projet EDUCATION" value="{{ old('auteur', $doc->auteur )}}">
                  </div>
                </div>
               <div class="col-lg-6">
                ...
                <div class="select" value="">
                    <select name="category_id"> 
                      <option value="{{ $doc->category_id }}">Sélectionner une Catégorie</option>
                        @foreach($categories as $category)
                         <option value="{{ $category->id }}"  {{old('category_id')=='2'? 'selected':''}}>{{ $category->name }}</option>
            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <br>
                <input id="fichier" type="file" class="form-control" name="fichier" disabled>
              ...
              <div class="col-lg-6">
                ...
                <div class="select">
                    <select name="visibility_id" value="{{ old('visibility_id', $doc->visibility()->first()->name)}}">
                      
                      <option value="{{ $doc->visibility_id }}">Sélectionner un niveau</option>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group green-border-focused">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="3" value="{{ old('description', $doc->description )}}"></textarea>
                  </div>
                </div>
              </div>
              <div class="row">
