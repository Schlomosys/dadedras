...
<div class="grid-container">
   ...
   <aside class="sidenav">
    ...
    <li class='sidenav__list-item sub-menu active'>
     ...
     <a href="" class="dropdown-toggle"  data-toggle="dropdown" style="color:white; font-weight:bold"> AJOUTER UN DOCUMENT </a>
      <ul>
        ...
        <li class="sidenav__list-item" style="color:white; font-weight:bold"> <a href="{{ route('admin.rolist') }}"  style="color:white; font-weight:bold">GESTION DES ROLES</a></li>
        <li class="sidenav__list-item" style="color:white; font-weight:bold"> <a href=""  style="color:white; font-weight:bold">GESTION DES CATEGORIES</a></li>
       <li class="sidenav__list-item" style="color:white; font-weight:bold"> <a href=""  style="color:white; font-weight:bold">GESTION DES ACCREDITATIONS</a></li>
   ...
   <main class="main">
     ...
     <h3 style=" display: flex; align-items: center; justify-content: center; "> DETAILS DOCUMENT  </h3>
         ...
         <div class="row">
             <div class="row">
                ...
                @if ($doc->photocouv!=null)
                       <img class="photocouv" alt="100x100" src="{{ asset($doc->image) }}" data-holder-rendered="true" style=" height: 200; width:200;" ></a>
                  @else
                       <img class="photocouv" alt="100x100" src="{{ asset("/uploads/images/documentpage.png") }}" data-holder-rendered="true" style=" height: 200; width:200;"></a>
                  @endif

                  <div>QR code</div>
                  <div><div class="btn btn-light"> Lire </div></div>
                  
                  <div><div class="btn btn-light"> Modifier </div></div>
                  
                  <div><div class="btn btn-light"> Supprimer </div></div>
             </div>
            <div class="col-lg-6">
                <div class="form-group focused">
                  <label class="form-control-label" for="auteur" style="color:black;">Titre: <span> {{ $doc->title }}</span></label>
                  
                </div>
              </div>
            <div class="col-lg-6">
                <div class="form-group focused">
                  <label class="form-control-label" for="auteur" style="color:black;">Auteur: <span> {{ $doc->auteur }}</span></label>
                  
                </div>
              </div> 
              <div class="col-lg-6">
                <div class="form-group focused">
                  <label class="form-control-label" for="auteur" style="color:black;">Type: <span> {{ $doc->type }}</span></label>
                  
                </div>
              </div> 
              <div class="col-lg-6">
                <div class="form-group focused">
                  <label class="form-control-label" for="auteur" style="color:black;">Langues: <span> {{ $doc->langues }}</span></label>
                  
                </div>
              </div> 
              <div class="col-lg-6">
                <div class="form-group focused">
                  <label class="form-control-label" for="auteur" style="color:black;">Introduction: <span> {{ $doc->introduction }}</span></label>
                  
                </div>
              </div> 
              <div class="col-lg-6">
                <div class="form-group focused">
                  <label class="form-control-label" for="auteur" style="color:black;">Description: <span> {{ $doc->description}}</span></label>
                  
                </div>
              </div> 
              <div class="col-lg-6">
                <div class="form-group focused">
                  <label class="form-control-label" for="auteur" style="color:black;">Validité: <span> {{ $doc->validity}}</span></label>
                  
                </div>
              </div> 
              <div class="col-lg-6">
                <div class="form-group focused">
                  <label class="form-control-label" for="auteur" style="color:black;">Status: <span> {{ $doc->active}}</span></label>
                  
                </div>
              </div> 
              <div class="col-lg-6">
                <div class="form-group focused">
                  <label class="form-control-label" for="auteur" style="color:black;">Nombre de pages: <span> {{ $doc->nombpages}}</span></label>
                  
                </div>
              </div> 
              <div class="col-lg-6">
                <div class="form-group focused">
                  <label class="form-control-label" for="auteur" style="color:black;">Nombre de vues: <span> {{ $doc->nombdevus}}</span></label>
                  
                </div>
              </div> 
              <div class="col-lg-6">
                <div class="form-group focused">
                  <label class="form-control-label" for="auteur" style="color:black;">Nombre de téléchargements: <span> {{ $doc->nombtelech}}</span></label>
                  
                </div>
              </div> 
              <div class="col-lg-6">
                <div class="form-group focused">
                  <label class="form-control-label" for="auteur" style="color:black;">Nombre de partages: <span> {{ $doc->nombpartage}}</span></label>
                  
                </div>
              </div> 
              <div class="col-lg-6">
                <div class="form-group focused">
                  <label class="form-control-label" for="auteur" style="color:black;">Date de création: <span> {{ $doc->creation_date}}</span></label>
                  
                </div>
              </div> 
              <div class="col-lg-6">
                <div class="form-group focused">
                  <label class="form-control-label" for="auteur" style="color:black;">Date d'enrégistrement: <span> {{ $doc->created_at}}</span></label>
                  
                </div>
              </div> 
              <div class="col-lg-6">
                <div class="form-group focused">
                  <label class="form-control-label" for="auteur" style="color:black;">Date de modification: <span> {{ $doc->updated_at}}</span></label>
          ...
          <form action="{{route('storeDoc')}}" method="POST"  enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="">
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="form-group focused">
                    <label class="form-control-label" for="name" style="color:black;">Nom: <span class="text-danger" style="opacity: 0.4;">*</span></label>
                    <input type="text" id="name"  name="name" class="form-control form-control-alternative" placeholder="Rapport d'activité 2020" value="">
                  </div>
                </div>
