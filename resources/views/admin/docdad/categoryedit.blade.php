     ...
     <div class="main-cards">
      <div class="carda">
        <div class="row">
          ...
          <form action="{{ route('updateCat',$cat->id) }}" method="POST"  enctype="multipart/form-data" class="form-horizontal">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group focused">
                    ...
                    <input type="text" id="name"  name="name" class="form-control form-control-alternative" placeholder="catégorie" value="{{ old('name', $cat->name )}}">
                  </div>
                </div>
                <div class="col-lg-6">
