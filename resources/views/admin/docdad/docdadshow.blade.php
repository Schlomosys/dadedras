...
@endif
     ...
     <h3 style=" display: flex; align-items: center; justify-content: center; "> DETAILS </h3>
     ...
     <div class="main-cards">
      ...
      <table>
        ...
        <tbody>
          ...
          <td data-label="Catégorie">{{ $doc->category()->first()->name }}</td>
          <td data-label="Accreditation">{{ $doc->visibility()->first()->name}}</td>
          <td data-label="QR Code">{!! QrCode::size(180)->generate($doc->title); !!}
          </td>
      ...
      <table>
        ...
        <tbody>
          ...
          <td data-label="Description">{{ $doc->description }}</td>
          <td data-label="Validité">{{ $doc->validity }}</td>
          <td data-label="Status">{{$doc->active }}</td>
          <td data-label="Nombre de vues">{{ $doc->nombdevus }}</td>
          <td data-label="Nombre de téléchargement">{{ $doc->nombtelech }}</td>
          <td data-label="Date de création">{{ $doc->creation_date }}</td>
          <td data-label="Date d'enrégistrement">{{ $doc->created_at }}</td>
          
          <td data-label="Date de modification">{{ $doc->updated_at }}</td>
          <!--<td><input type="checkbox" name="checkbox[]" value="" ></td>-->
