...
@endif
     ...
     <h3 style=" display: flex; align-items: center; justify-content: center; "> ACCREDITATIONS MANAGEMENT  </h3>
     ...
     <div class="main-cards">
      <div class="carda">
        <div class="row">
            ...
            @can('role-create')
            <div class="btn btn-success" href="" data-toggle="modal" data-target="#modalVis"> Create New Accreditation</div>
            @endcan
            </div>
            </div>
            </div>
            ...
            <table>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td data-label="#">{{ $visibility->id }}</td>
                <td data-label="Name">{{ $visibility->name }}</td>
                
                <td data-label="Action">

                  <!--<a class="btn btn-info" href="{{ route('roles.show',$visibility->id) }}">Show</a>-->
            @can('role-edit')
            <a class="btn btn-primary" href="{{ route('editVis',$visibility->id) }}">Edit</a>
            @endcan
            @can('role-delete')
            {!! Form::open(['method' => 'DELETE','route' => ['destroyVis', $visibility->id],'style'=>'display:inline']) !!}
...
<div id="modale" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <!-- Modal HTML Markup -->
    <div id="modalVis" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
        <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" style="color:black;">Ajouter une accréditation</h4>
          <button type="button" class="close" data-dismiss="modal">
            <span>&times;</span>
          </button> 
        </div>
        ...
        <div class="col-xl-12 order-xl-1">
          @if ($errors->any())
              ...
              <div class="alert alert-success">
               ...
               @endif
              <form action="{{route('storeVis')}}" method="POST"  enctype="multipart/form-data" class="form-horizontal">
                <h6 class="" style="text-align: center;font-family:Impact, Charcoal, sans-serif;"></h6>
                @csrf
                @if ($message = Session::get('success'))
                  <div class="alert alert-success">
                ...
                <div class="">
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="title" style="color:rgb(255, 255, 255);">Nom: <span class="text-danger" style="opacity: 0.4;">*</span></label>
                        <input type="text" id="title"  name="name" class="form-control form-control-alternative" placeholder="Accréditation" value="">
                      </div>
                    </div>
                    <div class="col-lg-6">
