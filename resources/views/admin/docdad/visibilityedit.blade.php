...
@endif
     ...
     <h3 style=" display: flex; align-items: center; justify-content: center; "> EDIT CATEGORY </h3>
     ...
     <div class="main-cards">
      <div class="carda">
        <div class="row">
          ...
          <form action="{{ route('updateVis',$vis->id) }}" method="POST"  enctype="multipart/form-data" class="form-horizontal">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group focused">
                    <label class="form-control-label" for="name" style="color:rgb(255, 255, 255);">Nom: <span class="text-danger" style="opacity: 0.4;">*</span></label>
                    <input type="text" id="name"  name="name" class="form-control form-control-alternative" placeholder="Accréditation" value="{{ old('name', $vis->name )}}">
                  </div>
                </div>
                <div class="col-lg-6">
