     ...
     <div class="main-cards">
      ...
      <table>
        ...
        <tbody>
          ...
          <a class="btn btn-info" href="{{ route('admin.docshow', $doc->id) }}">Details</a>
          <a class="btn btn-primary" href="{{ route('editdoc', $doc->id) }}">Modifier</a>
       
          {!! Form::open(['method' => 'DELETE','route' => ['deleteDoc', $doc->id],'style'=>'display:inline']) !!}
...
<!--CODEE__-->
 ...
 <div id="modal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    <h4 class="modal-title" style="color:black;">Modifier le document</h4>
