...
font-weight: bold; color:black; margin-top:100px;"><img class="photocouv" alt="100x100" src="{{ asset("/uploads/images/dadlogo.png") }}" data-holder-rendered="true" style="height:50px; width:125px; margin-top:-50px;"></div>
<div class="container" style="">
  <h1 class="row justify-content-center" style="font-family: 'Dosis';
      font-weight: bold; color:black;"> INSCRIPTION</h1>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="firstname" class="col-md-4 col-form-label text-md-right" style="font-family: 'Dosis';
                            font-weight: bold;">{{ __('Prénom') }}</label>

                            <div class="col-md-6">
                                <input id="firstname" type="text" class="form-control @error('firstname') is-invalid @enderror" name="firstname" value="{{ old('firstname') }}" required autocomplete="Prénom" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="lastname" class="col-md-4 col-form-label text-md-right" style="font-family: 'Dosis';
                            font-weight: bold;">{{ __('Nom') }}</label>

                            <div class="col-md-6">
                                <input id="lastname" type="text" class="form-control @error('lastname') is-invalid @enderror" name="lastname" value="{{ old('lastname') }}" required autocomplete="Nom" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right"style="font-family: 'Dosis';
                            font-weight: bold;">{{ __('Confirmer le Mot de passe') }}</label>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 offset-md-4">
                                <a href="{{ route('sociallogin','facebook') }}" class="btn btn-facebook">Facebook</a>      
                            </div>
                        </div>
