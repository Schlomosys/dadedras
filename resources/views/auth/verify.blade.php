            ...
            <div class="card">
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                           <!-- <div class="card">-->
                                <div class="card-header" style="font-weight: bold;">{{ __('Vérifier votre addresse e-mail') }}</div>
                
                                <div class="card-body">
                                    @if (session('resent'))
                                        <div class="alert alert-success" role="alert">
                                            {{ __('Un nouveau lien de vérification a été expédié, consultez vos emails.') }}
                                        </div>
                                    @endif
                
                                    {{ __("Avant de poursuivre, vérifiez vos emails. Un email avec un lien de confirmation d'ouverture de compte vous a été expédié.") }}
