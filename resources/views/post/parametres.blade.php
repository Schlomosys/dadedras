...
<div class="grid-container">
  ...
  <ul class="siderbar_menu">
   ...
   <li><a href="{{route('parametres')}}" class="active">
...
@endif
     ...
     <h3 style="display: flex; align-items: center; justify-content: center; color:#045480;font-weight:bold" >PARAMETRES</h3>
     ...
     <div class="main-cards">
      <div class="carda">
        <div class="row">
          ...
          <div class="container">
            <div class="grid-row">
               <div class="btn btn-outline-secondary"> Regeneration</div>
