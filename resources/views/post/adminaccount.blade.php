...
<div class="grid-container">
  ...
  <ul class="siderbar_menu">
      <li><a href="{{ route('user.account', $user->pseudo) }}" class="active">
   ...
   <main class="main">
     <div class="main-header">
       <div class="main-header__heading" style="font-weight:bold; font-size:20px; text-transform:uppercase; margin-top:-15px;" > <div class="">
        <form action="{{ route("user.account", $user->firstname) }}" method="GET" role="search">
            ...
            <div class="input-group">
              ...
              <a href="{{ route("user.account",$user->firstname) }}" class=" ">
...
@endif
     ...
     <h3 style="display: flex; align-items: center; justify-content: center; color:#045480;font-weight:bold" >DOCUMENTS ACCESSIBLES</h3>
        ...
        <div class="row">
          ...
          <div class="container">
            <div class="grid-row">
              ...
              <div class="grid-item">
                <a class="wrapping-link" href="{{route('accountread',$doc->id)}}"></a>
                ...
                <a href="{{route('accountread',$doc->id)}}" style=" height:50px; width:90%; padding-left:5%;" > <div class="" >
              
                    <h5 style="font-family: 'Dosis';
                    font-weight: bold;"> {{ $doc->title }} </h5>
                  </div></a>
              </div>
               @endforeach
