...
<div class="grid-container">
  ...
  <ul class="siderbar_menu">
    ...
    <li><a href="{{route('user.postLists',$user->pseudo)}}" >
        <div class="icon"><i class="fas fa-file-alt"></i></div>
        <div class="title">FORUM</div>
        </a></li>  
        <li><a href="{{route('favorites',$user->pseudo)}}" class="active">
          <div class="icon"><i class="fas fa-heart"></i></div>
          <div class="title">FAVORIS</div>
          </a></li>  
      <li><a href="{{route('historique',$user->pseudo)}}">
            <div class="icon"><i class="fas fa-clock"></i></div>
            <div class="title">HISTORIQUE</div>
            </a></li>      
     <li><a href="{{route('parametres')}}">
          <div class="icon"><i class="fas fa-cog"></i></div>
          <div class="title">PARAMÈTRES</div>
          </a></li>  
      <li><a href="{{route('aide')}}">
   ...
   <main class="main">
     <div class="main-header">
       <div class="main-header__heading" style="font-weight:bold; font-size:20px; text-transform:uppercase; margin-top:-15px;" > <div class="">
        <form action="{{route('user.postLists',$user->pseudo)}}" method="GET" role="search">

            <div class="input-group">
            
                
                <input type="text" class="form-control border-secondary rounded-pill pr-5" name="term" placeholder="Rechercher un post" id="term">
                <div class="col-auto">
                  <button class="btn btn-outline-light text-dark border-0 rounded-pill ml-n5" type="button">
                      <i class="fa fa-search"></i>
                  </button>
              </div>
              <a href="{{route('user.postLists',$user->pseudo)}}" class="">
...
@endif
     ...
     <h3 style=" display: flex; align-items: center; justify-content: center;  color:black;color:#045480;font-weight:bold;">FAVORIS </h3>
     <div class="title m-b-md">
      <div class="col-xs-12 col-sm-12 col-md-12 ">
        <button  data-toggle="modal" data-target="#modale" type="" class="btn btn-secondary">Ajouter un Post</button>
        </div>
    </div>
        ...
        <div class="row">
          ...
          <div class="container">
            ...
            <div class="row"  style="display: flex;flex-direction: row;justify-content:flex-start; ">
              ...
              <div class="ufirstname" style="padding-left:10px; padding-right:10px; font-weight:bold; color:black;">
                {{ $post->user->firstname }} 
                {{-- $post->user->firstname --}}
            </div>
          ...
          <!--<a href="{{-- route('post.show',$post->slug) --}}">-->
           <div class="card-footer bg-transparent border-success">
            <div id="conteneur" style=" display: flex;flex-direction: row;justify-content: space-between; ">
              ...
              @else
              <div><h1> Vous n'avez pas encore de post favoris</h1><div>
              @endif 
