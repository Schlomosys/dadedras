...
<div class="grid-container">
  ...
  <ul class="siderbar_menu">
   ...
   <li><a href="{{route('parametres')}}">
    ...
    <li><a href="{{route('aide')}}" class="active">
...
@endif
     ...
     <h3 style="display: flex; align-items: center; justify-content: center; color:#045480;font-weight:bold" >AIDE</h3>
     ...
     <div class="main-cards">
      <div class="carda">
        <div class="row">
          ...
          <div class="container">
            <div class="grid-row">
              <div class="btn btn-outline-danger"> Contacter l'administrateur<div>
