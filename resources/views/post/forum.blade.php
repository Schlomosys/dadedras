...
<div class="grid-container">
  ...
  <ul class="siderbar_menu">
    ...
    <li><a href="{{route('user.postLists',$user->pseudo)}}" class="active">
        ...
        <li><a href="{{route('favorites',$user->pseudo)}}">
...
@endif
     ...
     <h3 style=" display: flex; align-items: center; justify-content: center;  color:black;color:#045480;font-weight:bold;"> POSTS </h3>
