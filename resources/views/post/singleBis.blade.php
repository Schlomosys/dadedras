      ...
      <div class="bg_shadow"></div>
        ...
        <div class="profile_info">
            <div class="profile_img">
              @if (auth()->user()->image)
              <a href="#" > <img class="rounded-circle z-depth-2" alt="100x100" src="{{ asset(auth()->user()->image) }}" data-holder-rendered="true" style="height:65px; width:65px;  object-fit: cover; " id="pic"></a>
        ...
        <ul class="siderbar_menu">
          ...
          <li><a href="{{route('user.postLists',$user->id)}}" class="active">
               ...
               <div class="card-footer bg-transparent border-success">
                <div id="conteneur" style=" display: flex;flex-direction: row;justify-content: space-between; ">
                  ...
                  <div class="element 3">
                    ...
                    <div  data-toggle="modal" data-target="#modalshare"><i class='fa fa-share fa-lg'></i><span class="" style="padding-left:15px; font-size:16; font-weight:bold;">{{ $post->seo_title }}</span></div>
