...
<div class="grid-container">
  ...
  <ul class="siderbar_menu">
    ...
    <li><a href="{{route('historique',$user->pseudo)}}" class="active">
...
@endif
     ...
     <h3 style="display: flex; align-items: center; justify-content: center; color:#045480;font-weight:bold" >HISTORIQUE</h3>
            ...
            <div class="grid-row">
                ...
                <table>
                  ...
                  <tbody>
                    ...
                    <td data-label="Titre">{{ $doc->docdad()->first()->title }}</td>
                    <td data-label="date">{{ $doc->datelecture}}</td>
                    
                    <!--<td><input type="checkbox" name="checkbox[]" value="" ></td>-->
                    
                    <td data-label="Action">
                    <a class="btn btn-info" href="">lire</a>
