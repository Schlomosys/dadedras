...
<script src="https://cdnjs.cloudflare.com/ajax/libs/pdfobject/2.2.5/pdfobject.min.js" integrity="sha512-K4UtqDEi6MR5oZo0YJieEqqsPMsrWa9rGDWMK2ygySdRQ+DtwmuBXAllehaopjKpbxrmXmeBo77vjA2ylTYhRA==" crossorigin="anonymous" referrerpolicy="no-referrer">

PDFObject.embed("{{$docdad->fichier}}", "#pdf-viewer");
</script>
<script>
</script>    
<!--CODEE__-->
...
<div class="page-wrapper ">
    ...
    <!-- <section class="headline">
      ...
      font-weight: bold; text-align:left;  ">Projets du Dedras</h1>
      <h4 style=" font-family: 'Dosis';
      font-weight: 200;text-align:left; color:white; ">Dedras a développé  pulsieurs projets suivants sur la base des programmes bien établis</h4>
    </section>-->
    
    <!-- <section class="features">-->
        <!--<embed src="{{ $docdad->fichier }}" type="application/pdf" width="100%" height="100%">
        <iframe src="C:/xampp/htdocs/dadedras/public{{ $docdad->fichier }}" width="100%" height="100%">
            This browser does not support PDFs. Please download the PDF to view it: 
            <a href="C:/xampp/htdocs/dadedras/public{{ $docdad->fichier }}">Download PDF</a></iframe>-->
           {{-- @if ($docdad->fichier)
            <iframe src ="{{asset('/laraview/#../'.$docdad->fichier) }}" id="pdflecteur"  style="width: 100%; height:1000px;"></iframe>
            @else
           ...
           <!-- <embed src="{{"http://127.0.0.1:8080/dadedras/public".$docdad->fichier }}" width=100% height=1000px type='application/pdf'/>-->
             {{-- objectdata=""http://dadedras.herokuapp.com/".$docdad->fichier }}" type="application/pdf" width="100%" height="1000px">
                ...
                <div  class="d-flex justify-content-center" style=" padding-top:50%;  height:75%;">
