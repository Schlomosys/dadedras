...
<!-- Remove the container if you want to extend the Footer to full width. -->
    ...
    <footer class="text-white text-center text-lg-start" style="background-color: #081d96;">
      <!-- Grid container -->
      <div class="container p-3">
        <!--Grid row-->
        <div class="row mt-4">
            <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
                <img class="photocouv" alt="100x100" src="{{ asset("/uploads/images/blanclogo.png") }}" data-holder-rendered="true" style=""></a>
