...
<div class="grid-container">
   ...
   <aside class="sidenav">
     ...
     <ul class="sidenav__list ">
      <li  class="sidenav__list-item a"> <a href="{{ route('listDocs') }}"  style="color:white; font-weight:bold"><div>DASHBOARD</div></a></li>
...
@endif
     ...
     <h3 style=" display: flex; align-items: center; justify-content: center; "> MODIFIER UN USER </h3>
     ...
     <div class="main-cards">
      <div class="carda">
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
            <strong>Niveau d'accréditation:</strong><div class="select">
                <select name="visibility_id">
                    
                    <option value="{{ $user->visibility_id }}">Sélectionner un niveau</option>
